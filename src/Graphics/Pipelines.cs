...
public class Pipelines
{
    ...
    public static Dictionary<PipelineType, GraphicsPipeline> CreatePipelines(GraphicsDevice device)
    {
        var pipelines = new Dictionary<PipelineType, GraphicsPipeline>();
    ...
    public static GraphicsPipeline CreateRimLightPipeline(GraphicsDevice device)
    {
        ...
        return new GraphicsPipeline(device, createInfo);
    }

    public static GraphicsPipeline CreateDiamondTransition(GraphicsDevice device)

    {
        ...
        var myGraphicsPipelineCreateInfo = new GraphicsPipelineCreateInfo
        {
            ...
            RasterizerState = RasterizerState.CCW_CullNone,
            PrimitiveType = PrimitiveType.TriangleList,
            VertexInputState = Pipelines.GetVertexInputState(),
        };

        return new GraphicsPipeline(device, myGraphicsPipelineCreateInfo);
    }
    public static GraphicsPipeline CreateSpritePipeline(GraphicsDevice device, ColorAttachmentBlendState blendState)
    {
    ...
    public static GraphicsPipeline CreateCircleCropTransition(GraphicsDevice device)
    {
    ...
    public static GraphicsPipeline CreatePixelize(GraphicsDevice device)
    {
