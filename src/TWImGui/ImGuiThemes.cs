...
public static class ImGuiThemes
{
	...
	public static void DarkTheme()
	{
		...
		colors[(int)ImGuiCol.FrameBg] = new Num.Vector4(41 / 255f, 41 / 255f, 41 / 255f, 1.0f); // new Num.Vector4(0.05f, 0.05f, 0.05f, 0.70f);
		...
		colors[(int)ImGuiCol.Tab] = new Num.Vector4(0.161f, 0.161f, 0.161f, 1.000f); //new Num.Vector4(0.00f, 0.00f, 0.00f, 0.52f);
		colors[(int)ImGuiCol.TabHovered] = new Num.Vector4(0.094f, 0.094f, 0.094f, 1.000f); //new Num.Vector4(0.1f, 0.2f, 0.25f, 1.00f);
		colors[(int)ImGuiCol.TabActive] = new Num.Vector4(0.094f, 0.094f, 0.094f, 1.000f); //new Num.Vector4(0.19f, 0.38f, 0.5f, 1.00f);
		colors[(int)ImGuiCol.TabUnfocused] = new Num.Vector4(0.094f, 0.094f, 0.094f, 1.000f); //new Num.Vector4(0.00f, 0.00f, 0.00f, 0.52f);
		colors[(int)ImGuiCol.TabUnfocusedActive] = new Num.Vector4(0.094f, 0.094f, 0.094f, 1.000f); //new Num.Vector4(0.14f, 0.14f, 0.14f, 1.00f);
